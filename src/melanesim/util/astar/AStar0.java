...
public class AStar0 {
    ...
    public AStar0(int rows, int cols, Node initialNode, Node finalNode, int hvCost, int diagonalCost) {
        this.hvCost = hvCost;
    ...
    public AStar0(int rows, int cols, Node initialNode, Node finalNode) {

...
public class C_Protocol_PNMC_drifters extends A_Protocol_PNMC {
	...
	// SPECIFIC METHODS
	//
	public C_Plankton createPlankton() { return new C_Plankton(new C_GenomeAnimalia()); }
	public C_Nekton createNekton() { return new C_Nekton(new C_GenomeAnimalia()); }

	/** Add plankton and micronekton particle in the center of each cell of the grid at a specified interval - JLF
	 * 07.2024 */
	...
	public void manageOneEvent(C_Event event) {
		...
		switch(event.type){
			case COMPUTE_ENERGY:// Permet de suivre l'évolution saisonnière par exemple
				// this.computeMaxMinIntegrals();// saveScreen();

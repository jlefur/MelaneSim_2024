...
import melanesim.protocol.C_Protocol_PNMC_temperature;
...
import melanesim.protocol.rodents.C_ProtocolChize;
import melanesim.protocol.rodents.C_ProtocolDecenal;
import melanesim.protocol.rodents.C_ProtocolDodel;
import melanesim.protocol.rodents.C_ProtocolDodel2;
import melanesim.protocol.rodents.C_ProtocolEnclosure;
import melanesim.protocol.rodents.C_ProtocolGerbil;
...
public class C_ContextCreator implements ContextBuilder<Object>, I_ConstantNumeric, I_ConstantStringRodents,
	...
	private void selectProtocol(Context<Object> context) {
		...
		else if (C_Parameters.PROTOCOL.equals(PNMC_TEMPERATURE)) protocol = new C_Protocol_PNMC_temperature(context);

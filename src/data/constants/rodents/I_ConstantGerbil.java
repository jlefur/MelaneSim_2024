...
public interface I_ConstantGerbil extends I_ConstantStringRodents {
	...
	public static String CHRONO_FILENAME = "/rodents/20170517_GerbilEventsJunk.3a.jlf.csv";
	...
	public static final String PATH_GERBIL="gerbils/";
	public static final Map<String, String[]> RASTER_PARAMETERS = new HashMap<String, String[]>() {
		{
			...
			put(RASTER_PATH_RODENTS + "zoom1", new String[]{RASTER_PATH_RODENTS + PATH_GERBIL+"Zoom_001_12.2015/landcover.txt", PATH_GERBIL+"Zoom_001_12.2015/",
					"-Zoom-Rain.txt", "30", "30", "-16.", "16.2"});
			put(RASTER_PATH_RODENTS + "zoom2", new String[]{RASTER_PATH_RODENTS +PATH_GERBIL+ "Zoom_002_12.2015/landcover.txt", PATH_GERBIL+"Zoom_002_12.2015/",
					"-Zoom-Rain.txt", "75", "45", "-15.45", "15.76"});
			put(RASTER_PATH_RODENTS + "zoom3", new String[]{RASTER_PATH_RODENTS + PATH_GERBIL+"Zoom_003_09.2016/landcover.txt", PATH_GERBIL+"Zoom_003_09.2016/",
					"-Zoom-Rain.txt", "3", "3", "-16.", "15.758572"});
			put(RASTER_PATH_RODENTS + "zoom4", new String[]{RASTER_PATH_RODENTS + PATH_GERBIL+"Zoom_004_01.2018/landcover.txt",PATH_GERBIL+ "Zoom_004_01.2018/",
					"-Zoom-Rain.txt", "5", "5", "-15.713078", " 16.421078"});
			put(RASTER_PATH_RODENTS + "pe", new String[]{RASTER_PATH_RODENTS +PATH_GERBIL+ "Zoom_PE_12.2015/landcover.txt", PATH_GERBIL+"Zoom_PE_12.2015/",
					"-Zoom-Rain.txt", "214", "110", "-16.", "15.758572"});
			put(RASTER_PATH_RODENTS + "me", new String[]{RASTER_PATH_RODENTS +PATH_GERBIL+ "Zoom_ME_03.2018/landcover.txt", PATH_GERBIL+"Zoom_ME_03.2018/",
					"-Zoom-Rain.txt", "700", "400", "-17.899695", " 13.616352"});
			put(RASTER_PATH_RODENTS + "fd", new String[]{RASTER_PATH_RODENTS + PATH_GERBIL+"Zoom_FD_2019.03/landcover.txt",PATH_GERBIL+ "Zoom_FD_2019.03/",
					"-Zoom-Rain.txt", "700", "400", "-17.899695", " 13.616352"});
		}
		private static final long serialVersionUID = 1L;
	};

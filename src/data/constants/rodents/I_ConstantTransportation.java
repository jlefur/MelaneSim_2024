...
public interface I_ConstantTransportation extends I_ConstantStringRodents {
	 ...
	 * plus utile MARKET est consid�r� comme un city 08/12/15 } private static final long serialVersionUID = 1L; };
	 */
	...
	public static final Map<String, String[]> GRAPH_TYPES_MAP = new HashMap<String, String[]>() {
		{
			put(ROAD_EVENT, new String[]{TRACK_EVENT, GOOD_TRACK_EVENT, ROAD_EVENT});// une cellule contenant track et road est r�ellement track

...
public interface I_ConstantDodel2 extends I_ConstantStringRodents {
	...
	// public static String CHRONO_FILENAME = "20211120_Dodel2Events.2a.testWalker.csv"; // newest chrono clean
	 public static String CHRONO_FILENAME = "/rodents/20211120_Dodel2Events.2a.csv";
//	public static String CHRONO_FILENAME = "20220520_Dodel2Events.Mice.csv";
	...
	public static String PATHS_FILENAME = "/rodents/20220517-path100s.csv";
	...
	public static final Map<String, String[]> RASTER_PARAMETERS = new HashMap<String, String[]>() {
		{
			...
			put(RASTER_PATH_RODENTS + "market", new String[]{
					"20201027-ZoomHouseRasteDodel2.1a.txt,20201027-ZoomRoomRasteDodel2.1a.txt",
					"-14.433808462406692,16.48482308819331"});
			put(RASTER_PATH_RODENTS + "aroundmarket", new String[]{
	...
	public static final Map<String, String[]> HUMANACTIVITY_FILES = new HashMap<String, String[]>() {
		{
			...
			// put(RASTER_PATH_RODENTS + "market", new String[]{"20210825-ChronoActivityMarket.temp.1a.csv"});
			put(RASTER_PATH_RODENTS + "market", new String[]{"/rodents/20211120-ChronoActivityMarket.2a.csv"});
			put(RASTER_PATH_RODENTS + "aroundmarket", new String[]{
					...
					"/rodents/20220119-ChronoActivityAroundMarket.3a.csv"});

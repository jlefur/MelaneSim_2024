...
public class C_Background implements I_SituatedThing {
	...
	@Override
	public int retrieveColNo() { return (int)this.whereY; }
	@Override
	public int retrieveLineNo() { return (int)this.whereX; }
	@Override
	public boolean isInfected() { return false; }
	@Override
	public Coordinate getCoordinate_Umeter() { return null; }
	@Override
	public Coordinate getCoordinate_Ucs() { return null; }
	@Override
	public I_Container getCurrentSoilCell() { return null; }
	@Override
	...
	@Override
	public boolean canInteractWith(I_SituatedThing oneOccupant) { return false; }
	@Override
	/** Used for compatibility with I_SituatedThing @rev JLF 10.2019 */
	...
	public String retrieveMyName() { return null; }
	@Override
	/** Used for compatibility with I_LivingThing @rev JLF 03.2025 */
	public double getBirthDate_Utick() { return 0; }
	@Override
	/** Used for compatibility with I_LivingThing @rev JLF 03.2025 */
	public double getAge_Uday() { return 0; }
	@Override
	/** Used for compatibility with I_LivingThing @rev JLF 03.2025 */
	public void actionGrowOlder_Utick() {}
	@Override
	/** Used for compatibility with I_LivingThing @rev JLF 03.2025 */
	public double getEnergy_Ukcal() { return 0; }
	@Override
	/** Used for compatibility with I_LivingThing @rev JLF 01.2026 */

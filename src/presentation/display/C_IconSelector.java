...
public class C_IconSelector implements I_ConstantStringRodents, I_ConstantPNMC, I_ConstantImagesNames {
	...
	/** D�finit la couleur de l'agent en param�tre en fonction de son sexe, de son �ge, son �tat... (A utiliser avec l'affichage
	...
	/** D�finit la couleur de l'agent en param�tre en fonction de son sexe et de son �ge (A utiliser avec l'affichage d'ellipses
	 * et non d'images)
	 * @return la nouvelle couleur de l'agent */

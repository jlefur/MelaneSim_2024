...
public class C_IconSelector implements I_ConstantStringRodents, I_ConstantPNMC, I_ConstantImagesNames {
	...
	public String getNameOfImagePNMC(I_SituatedThing agent) {
		if(agent instanceof C_StreamCurrent){
			...
			else if(whale.retrieveMyName().contains("tagged")){
				if(whale.testMale()) return WHALE_MALE_TAGGED_ICON;
				else return WHALE_FEMALE_TAGGED_ICON;
			}
			else{
				if(whale.testMale()) return WHALE_MALE_ICON;
	...
	/** D�finit la couleur de l'agent en param�tre en fonction de son sexe, de son �ge, son �tat... (A utiliser avec
	 * l'affichage d'ellipses et non d'images)
	...
	public static Color getColorGerbil(I_SituatedThing agent) {
		...
		/*
		 * if (agent instanceof C_SoilCellSavanna) { switch ((((C_SoilCellSavanna) agent)).getRain_Umm()) { case 0 :
		 * rainColor = new Color(0, 0, 0);// water or river break; case 1 : rainColor = new Color(34, 254, 33);// 90-140
		 * mm break; case 2 : rainColor = new Color(226, 254, 43);// 40-80 mm break; case 3 : rainColor = new Color(35,
		 * 30, 252);// 210-260 mm break; case 4 : rainColor = new Color(2, 221, 221);// 150-200 break; case 5 :
		 * rainColor = new Color(254, 254, 165);// 20-30 mm break; case 6 : rainColor = new Color(255, 255, 212);// 10
		 * mm break; case 7 : rainColor = new Color(255, 255, 253);// 0 mm break; case 8: rainColor = new Color(190, 1,
		 * 254);// >= 270 mm break; default : rainColor = new Color(0, 0, 0); break; } }
		 */
	...
	/** D�finit la couleur de l'agent en param�tre en fonction de son sexe et de son �ge (A utiliser avec l'affichage

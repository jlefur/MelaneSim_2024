...
public class C_GenomeMusMusculus extends C_GenomeAmniota {
	...
	public C_GenomeMusMusculus() {
		...
		alleles.put(SPEED_UmeterByDay, 4000.);// source : Lorenz, G. C., & Barrett, G. W. (1990). Influence of simulated landscape corridors on house mouse (Mus musculus) dispersal. American Midland Naturalist, 348-356.

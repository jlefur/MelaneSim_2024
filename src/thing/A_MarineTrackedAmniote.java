...
/** Abstract tracked animals have a daily activity list with location and desires list with desires for each slice of days.<br>
 * They do not deliberate but got their activity location and perform the corresponding desire<br>
 * @author J.Le Fur, oct 2019, jan-feb 2020, 03.2021, 06.2022, 05.2026 */
public abstract class A_MarineTrackedAmniote extends A_Amniote implements I_ConstantDodel2 {
	//
	// FIELDS
	//
	...
	// CONSTRUCTOR
	//
	public A_MarineTrackedAmniote(I_DiploidGenome genome) {
		super(genome);
		this.setDesire(NONE);
		this.setAim(NONE);
	}
	...
	// OVERRIDEN METHODS
	//
	/** Tracked animal do not need to make a perception, they are driven by their activityList */
	@Override
	protected TreeSet<I_SituatedThing> perception() {
		return null;
	}
	/** Tracked animal do not deliberate, they are driven by their activityList */
	@Override
	protected TreeSet<I_SituatedThing> deliberation(TreeSet<I_SituatedThing> perceivedThings) {
		return null;
	}
	/** Tracked animal do not choose a destination, they are driven by their activityList */
	@Override

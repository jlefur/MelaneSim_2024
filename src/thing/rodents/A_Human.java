...
public abstract class A_Human extends A_Amniote {
	//
	// CONSTRUCTOR
	//
	/** used to allow the giveBirth procedure
	 * @see #giveBirth */
	public A_Human(I_DiploidGenome genome) { super(genome); }
	//
	// OVERRIDEN METHODS
	//
	/** Do not interact with other animals */
	@Override
	protected boolean actionInteract(A_Animal animal) { return false; }
	/** Do not check death */
	@Override
	public void checkDeath(double deathProbability) { this.dead = false; }

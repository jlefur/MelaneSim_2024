...
public class C_HumanCarrier extends A_Human implements I_ConstantStringRodents, I_ConstantTransportation {
	...
	// TODO PAM 2016.10 unifier cette m�thode avec goParked reachPathEndNow
	@Override
	...
	// TODO PAM 2016.10 unifier cette m�thode avec la m�thode goParked()
	...
	protected TreeSet<I_SituatedThing> deliberation(TreeSet<I_SituatedThing> candidateCells) {
		...
		if (currentCity != null) // TODO Ms to JLF 01.2021 Correction Bug : j'ai ajout� une v�rification sur currentCity pour
	 ...
	 * @see melanesim.util.C_PathWanderer

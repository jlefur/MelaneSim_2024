...
public class C_SoilCellMarineEnergy extends C_SoilCell {
	...
	protected final Valeurs[] valeurs;// STOCKAGE INTERNE : enum + tableau
	//
	// INTERNAL CLASS
	//
	protected static final class Valeurs {// OBJET VALEUR GÉNÉRIQUE
		// FIELD
		protected final double[] champs = new double[Champ.values().length];
		// SETTER and GETTER

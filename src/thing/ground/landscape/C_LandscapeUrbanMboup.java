...
/**testing landscape with dijkstra for Dodel2 - Le Fur 01.2022*/
public class C_LandscapeUrbanMboup extends C_LandscapeNetwork implements I_ConstantDodel2 {
	public C_LandscapeUrbanMboup(Context<Object> context, String url, String gridValueName, String continuousSpaceName) {

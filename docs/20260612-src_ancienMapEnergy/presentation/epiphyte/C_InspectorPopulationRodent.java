...
public class C_InspectorPopulationRodent extends C_InspectorPopulation {
	...
	// CONSTRUCTOR
	//
	public C_InspectorPopulationRodent() {
		super();
		rodentList.clear();

...
public class C_ConvertRainFiles implements I_ConstantStringRodents, I_ConstantGerbil {
    ...
    public int[][] readRainRaster(String fileNameInRain) {
        int[][] rainMatrix = C_ReadRaster.imgRasterLoader(RASTER_PATH_RODENTS + fileNameInRain);
    ...
    public static void saveRainRasterFile(int[][] matriceLue, String fileNameInRain, String path) {
        ...
        rasterFile_Utxt = new C_FileWriter(RASTER_PATH_RODENTS + path + "/" + fileNameInRain + ".txt", false);
    ...
    public static void main(String[] args) {
        int[][] matriceMELue;
        String rainBitmapFolder = "gerbils/rain-bitmaps-ME/";
        C_ConvertRainFiles converter = new C_ConvertRainFiles();
        TreeSet<String> fileNameList = C_ConvertRainFiles.buildFileNameList(RASTER_PATH_RODENTS + rainBitmapFolder);
        // build all ME matrix
        for (String fileNameInRain : fileNameList) {
            if (! fileNameInRain.contains("svn")) {
                ...
                C_ConvertRainFiles.saveRainRasterFile(matriceMELue, converter.computeFileName(fileNameInRain), "gerbils/rain-ASCII-ME");
            }
        }
